...
// full list at https://iam.ebrains.eu/auth/realms/hbp/.well-known/openid-configuration
const YOUR_APP_SCOPES = 'openid team email profile clb.wiki.read clb.drive:read clb.drive:write collab.drive';
